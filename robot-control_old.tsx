  ...
  return (
    <div className="w-full h-screen bg-black overflow-hidden relative" ref={containerRef}>
      ...
      {!leftTouch.isActive && !rightTouch.isActive && !cameraControl.isActive && (
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white text-center bg-black bg-opacity-70 px-6 py-3 rounded-lg z-20">
          <div className="text-lg font-semibold mb-2">Robot Control</div>
          <div className="text-sm">
            <span className="text-blue-400">Left:</span> Forward/Back •<span className="text-green-400"> Center:</span>{" "}
            Camera Pan/Tilt •<span className="text-red-400"> Right:</span> Left/Right Turn
          </div>
